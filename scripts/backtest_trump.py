...
def run_trump_best_backtest():
    ...
    print(f"--- TRUMP/USDT Best Optimization Backtest ---")
    print(f"Params: Vol_Mult={best_params['VOL_MULTIPLIER']}, Trail={best_params['TRAILING_ATR_MULT']}, Risk={best_params['RISK_PER_TRADE']}")
