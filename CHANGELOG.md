...
- **Volume Chart Scaling Fix**: Corrected volume reconstruction for charting to divide `vol_ratio` by 100 first, eliminating the huge rightmost bar spikes that distorted the volume charts.
